      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (907) 262-8741 to exercise any of these rights; we will respond within the time
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            <strong>We do not sell or share your personal information.</strong> Bearup International
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (907) 262-8741. We will verify your request using information associated with your
