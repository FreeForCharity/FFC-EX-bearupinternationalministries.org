...
export const metadata: Metadata = {
  title: 'Terms of Service | Bearup International Ministries',
  description: 'Terms of Service for Bearup International Ministries website',
}
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">
            Bearup International Ministries Terms of Service
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to Bearup International Ministries! These Terms of Service (“Terms”) govern your
            access to and use of our website, services, and platforms (collectively, “Services”),
            provided by Bearup International Ministries (“we,” “us,” or “our”). By accessing or
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of Bearup International
              Ministries’ mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to Bearup International Ministries are voluntary and non-refundable.
          </p>

          {/* Payments */}
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">Payments</h1>
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to Bearup International Ministries are voluntary and non-refundable.
            No refunds will be given due to the nonprofit nature of Bearup International Ministries.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of Bearup International Ministries or its licensors. You agree not to
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by Bearup International Ministries. We are not responsible for the content,
            privacy policies, or practices of any third-party websites or services. You acknowledge
            and agree that Bearup International Ministries shall not be liable for any damages or
            loss caused by or in connection with your use of any third-party websites or services.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. Bearup International
            ...
            otherwise. Bearup International Ministries disclaims all warranties, express or implied,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, Bearup International Ministries shall not be
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless Bearup International Ministries, its
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            {/* TODO: church/legal to confirm governing law / jurisdiction (e.g., State of Alaska). */}
            These Terms shall be governed by and construed in accordance with the laws of the United
            States and the State of TODO: confirm governing state, without regard to its conflict of
            law principles.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting Bearup International Ministries and for complying with these
            Terms of Service.
          </p>
        </div>
      </div>
